...
%				is not forwarded). This may have a cause, but is messy anyway.
	...
	\section*{Møil}
		...
		\ac{CoC}, \ac{DRY} and \ac{MVC}. Additionally, the \ac{Rails} community
		is quite vivid and there is an huge ecosystem of extensions for many
		recurrent problems.
		\s
		...
		\subsection*{Features}
			As the time of writing this document, \emph{Møil} comes with the
			following features.
			...
			\begin{description}
				...
				\item[\rm Permissions and Roles]\ \\
					...for Mailboxes to e.g. manage a certain domain.
					\todo
